...
class EventListTableViewController: UIViewController {
    ...
    func populateModels() {
        ...
        let first = ArtistModel(artistName: "Beyonce", imageName: "Beyoncé", concertDetails: firstConcertDetail)
        ...
        let second = ArtistModel(artistName: "David Guetta", imageName: "David guetta", concertDetails: secondConcertDatail)
        ...
        let third = ArtistModel(artistName: "Eminem", imageName: "eminem", concertDetails: thirdConcertDetail)
        ...
        let fourth = ArtistModel(artistName: "Drake", imageName: "Drake", concertDetails: fourthConcertDetail)
        ...
        let fifth = ArtistModel(artistName: "Ariana Grande", imageName: "Ariana Grande", concertDetails: fifthConcertDetail)
        
        self.eventList = [first,second,third,fourth,fifth]
    }
